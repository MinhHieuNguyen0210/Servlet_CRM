...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href='<c:url value="/SERVLET_CRM/static/plugins/images/favicon.png"></c:url>'>
    ...
    <!-- color CSS -->
    <link href='/SERVLET_CRM/static/css/colors/blue.css' id="theme" rel="stylesheet">
